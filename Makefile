...
PKG_MAKEFILE  = $(or $($(1)_MAKEFILE),$(TOP_DIR)/src/$(1).mk)
PKG_MAKEFILES = $(sort $(wildcard $(addsuffix /$(1).mk, $(TOP_DIR)/src $(MXE_PLUGIN_DIRS))))
PKG_TESTFILES = $(sort $(wildcard $(addsuffix /$(1)-test*, $(TOP_DIR)/src $(MXE_PLUGIN_DIRS))))
PKG_PATCHES   = $(sort $(wildcard $(addsuffix /$(1)-[0-9]*.patch, $(TOP_DIR)/src $(MXE_PLUGIN_DIRS))))
...
PLUGIN_FILES := $(wildcard $(addsuffix /*.mk,$(MXE_PLUGIN_DIRS)))
